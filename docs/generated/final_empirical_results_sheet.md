...
- completed `Llama-8B GRPO` multiseed checkpoint through seeds `42–57,59,61`:
  - mean conflict-minus-no-conflict ECE delta: `+0.0061`
  - bootstrap `95% CI`: `[-0.0221, +0.0316]`
  - source:
    [llama8_grpo_18seed_theorem3_ci.md](/Users/aryavdas/Downloads/Sequential%20Falsification%20with%20Calibrated%20Confidence/docs/generated/llama8_grpo_18seed_theorem3_ci.md)
...
- the current `18`-seed checkpoint is very close to flat and still not a decisive
  headline result
...
- The active multiseed rerun tempers the certainty of the single-seed picture:
  the newest completed `18`-seed checkpoint is only `+0.0061` with CI crossing
