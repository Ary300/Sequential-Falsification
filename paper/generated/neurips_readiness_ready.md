...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| Qwen/Qwen2.5-Coder-14B-Instruct | humaneval_plus | 23.2 | 43.9 | 43.9 | -- | 45.7 | 92.0% | 0.0 | -- |
| Qwen/Qwen2.5-Coder-14B-Instruct | mbpp_plus | 71.6 | 75.1 | 75.2 | -- | 80.3 | 40.2% | -0.1 | -- |
| Qwen/Qwen2.5-Coder-14B-Instruct | math500 | 24.1 | 34.3 | 34.3 | 34.3 | 34.3 | 100.0% | 0.0 | 0.0 |
| deepseek-ai/DeepSeek-R1-Distill-Qwen-32B | humaneval_plus | 29.9 | 82.9 | 82.3 | -- | 84.8 | 96.5% | 0.6 | -- |
| deepseek-ai/DeepSeek-R1-Distill-Qwen-32B | mbpp_plus | 30.8 | 64.4 | 64.6 | -- | 66.8 | 93.3% | -0.2 | -- |
| deepseek-ai/DeepSeek-R1-Distill-Qwen-7B | humaneval_plus | 32.9 | 70.7 | 72.6 | -- | 74.4 | 91.1% | -1.9 | -- |
| deepseek-ai/DeepSeek-R1-Distill-Qwen-7B | mbpp_plus | 10.8 | 33.8 | 33.8 | -- | 34.8 | 95.8% | 0.0 | -- |
...
- `seeds` Qwen/Qwen2.5-Coder-14B-Instruct :: humaneval_plus: Only 1 complete seed runs; target is 3.
- `baseline` Qwen/Qwen2.5-Coder-14B-Instruct :: humaneval_plus: Missing core methods: generated_test_filter
- `proxy` Qwen/Qwen2.5-Coder-14B-Instruct :: humaneval_plus: Missing local proxy baselines: code_t_proxy, s_star_proxy
- `baseline` Qwen/Qwen2.5-Coder-14B-Instruct :: mbpp_plus: Missing core methods: generated_test_filter
...
- `missing` Qwen/Qwen2.5-Coder-14B-Instruct :: livecodebench_v6: No row for target benchmark/model pair.
- `seeds` Qwen/Qwen2.5-Coder-14B-Instruct :: math500: Only 0 complete seed runs; target is 3.
- `seeds` deepseek-ai/DeepSeek-R1-Distill-Qwen-32B :: humaneval_plus: Only 1 complete seed runs; target is 3.
- `baseline` deepseek-ai/DeepSeek-R1-Distill-Qwen-32B :: humaneval_plus: Missing core methods: generated_test_filter
...
- `baseline` deepseek-ai/DeepSeek-R1-Distill-Qwen-7B :: humaneval_plus: Missing core methods: generated_test_filter
- `proxy` deepseek-ai/DeepSeek-R1-Distill-Qwen-7B :: humaneval_plus: Missing local proxy baselines: code_t_proxy, s_star_proxy
- `self_debug` deepseek-ai/DeepSeek-R1-Distill-Qwen-7B :: humaneval_plus: Falsification trails self-debug by 1.9 points.
- `baseline` deepseek-ai/DeepSeek-R1-Distill-Qwen-7B :: mbpp_plus: Missing core methods: generated_test_filter
