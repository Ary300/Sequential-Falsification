...
def _benchmark_profile(name: str) -> dict[str, float]:
    profiles = {
        ...
        "triviaqa": {"prior": 0.72, "dynamicity": 0.10, "conflict": 0.42, "context": 0.74},
        ...
        "hotpotqa": {"prior": 0.46, "dynamicity": 0.14, "conflict": 0.62, "context": 0.80},
        "tabmwp": {"prior": 0.28, "dynamicity": 0.04, "conflict": 0.54, "context": 0.76},
        "faitheval": {"prior": 0.50, "dynamicity": 0.20, "conflict": 0.84, "context": 0.64},
        "ambigdocs": {"prior": 0.42, "dynamicity": 0.10, "conflict": 0.74, "context": 0.72},
        "ramdocs": {"prior": 0.40, "dynamicity": 0.12, "conflict": 0.80, "context": 0.70},
        "clasheval": {"prior": 0.50, "dynamicity": 0.18, "conflict": 0.78, "context": 0.71},
        "gpqa": {"prior": 0.22, "dynamicity": 0.06, "conflict": 0.66, "context": 0.60},
        "climatex": {"prior": 0.18, "dynamicity": 0.26, "conflict": 0.46, "context": 0.77},
