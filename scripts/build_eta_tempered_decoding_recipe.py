...
def build_summary(eta: dict) -> dict:
    ...
    return {
        ...
        "recipe": [
            ...
            "Generate standard CoT traces once, then sweep eta in [0.0, 1.0] over the post-trace answer distribution.",
            "Choose the held-out Brier-optimal eta on the calibration split, and optionally report the largest no-harm eta as a conservative operating point.",
